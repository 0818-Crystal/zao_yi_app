...
import bac from "../static/img/foureyes.jpg";
const { width, height } = Dimensions.get("window");

export default class FourEyes extends React.Component {
  state = {
    paused: true
  };
  render() {
    return (
      <ImageBackground source={bac} style={styles.container}>
        <Header style={styles.header} androidStatusBarColor="#000">
          <Left>
            <Icon type="material" name="reorder" color="#e8d3a0" size={25} />
          </Left>

          <Right>
            <Icon type="material" name="share" color="#e8d3a0" size={25} />
          </Right>
        </Header>
        <Icon
          type="material"
