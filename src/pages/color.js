...
export default class Color extends React.Component {
  ...
  updateHue = async h => {
    await this.setState({ color: { ...this.state.color, h } }),
      this.props.changeState(this.state.color);
  };
  updateSaturation = async s => {
    await this.setState({ color: { ...this.state.color, s } }),
      this.props.changeState(this.state.color);
  };
  updateLightness = async l => {
    await this.setState({ color: { ...this.state.color, l } }),
      this.props.changeState(this.state.color);
  };
    ...
    return (
      <View style={styles.container}>
        <ScrollView contentContainerStyle={styles.content}>
          <Text style={styles.sectionText}>颜色选择器</Text>
          <Text style={styles.componentText}>当前</Text>
          <TouchableOpacity
          ...
          <Text style={styles.sectionText}>颜色滑动条</Text>
