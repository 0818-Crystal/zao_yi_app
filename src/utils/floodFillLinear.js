 ...
 *            容忍度
 */
async function floodFillLinear(pixelData, canvas, x, y, fillColor, tolerance) {
  /**
   * 相关数据准备
   */
  ...
  //   await context.getImageData(0, 0, width, height).then(imageData => {
